...
class AppointmentController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            // Staff restriction: Cannot reschedule confirmed, completed, cancelled, or missed appointments
            if (in_array($appointment->status, ['Confirmed', 'Completed', 'Cancelled', 'Missed'])) {
    ...
    private function autoCancelStalePendingAppointments(): void
    {
        try {
            ...
            foreach ($pendingAppointments as $appointment) {
                ...
                \Log::info('Auto-cancelled pending appointment past date', [
                    'appointment_id' => $appointment->id,
