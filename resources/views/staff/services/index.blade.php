    ...
    <div class="services-hero mb-4">
        <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
            <div>
                ...
                <p class="mb-0 opacity-75">Everything you can schedule for a patient, complete with duration and notes.</p>
            </div>
    ...
    <div class="services-table-wrapper">
        @if($clinicServices->isEmpty())
            <div class="p-5 text-center text-muted">
                ...
                <p class="mb-0">Once services are added by administrators, they will appear here.</p>
            </div>
        @else
