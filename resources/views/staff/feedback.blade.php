...
<style>
    ...
    .filter-card .form-select:focus {
        ...
        background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%230a58ca' stroke-linecap='round' stroke-linejoin='round' stroke-width='2.5' d='M2 5l6 6 6-6'/%3e%3c/svg%3e");
    }
    ...
    [data-theme="dark"] .filter-card .form-label[style*="color: #0d6efd"],
    [data-theme="dark"] .filter-card label[style*="color: #0d6efd"] {
    ...
    [data-theme="dark"] .filter-card .form-select {
        ...
        background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%230d6efd' stroke-linecap='round' stroke-linejoin='round' stroke-width='2.5' d='M2 5l6 6 6-6'/%3e%3c/svg%3e") !important;
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div class="d-flex align-items-center">
                    <div class="rounded-circle d-flex align-items-center justify-content-center me-3"
                         style="width: 50px; height: 50px; background: linear-gradient(135deg, #0d6efd 0%, #0a58ca 100%); box-shadow: 0 4px 12px rgba(13, 110, 253, 0.3);">
                        <i class="bi bi-chat-dots-fill text-white" style="font-size: 1.5rem;"></i>
                    </div>
                    <div>
                        <h2 class="mb-0 fw-bold" style="color: #0d6efd;">All Patient Feedback</h2>
                        <small class="text-muted">Complete list of patient reviews and ratings</small>
                    </div>
                </div>
                <a href="{{ route('staff-dashboard') }}" class="btn btn-outline-primary feedback-header-btn">
    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="card border-0 shadow-sm filter-card">
                <div class="card-body">
                    <form method="GET" action="{{ route('staff-feedback') }}" class="row g-4 align-items-end">
                        <div class="col-lg col-md-4 col-6 mb-2 mb-lg-0">
                            <label for="serviceFilter" class="form-label fw-semibold" style="color: #0d6efd;">
                        ...
                        <div class="col-lg col-md-4 col-6 mb-2 mb-lg-0">
                            <label for="ratingFilter" class="form-label fw-semibold" style="color: #0d6efd;">
                        ...
                        <div class="col-lg col-md-4 col-6 mb-2 mb-lg-0">
                            <label for="monthFilter" class="form-label fw-semibold" style="color: #0d6efd;">
                        ...
                        <div class="col-lg col-md-4 col-6 mb-2 mb-lg-0">
                            <label for="sortFilter" class="form-label fw-semibold" style="color: #0d6efd;">
                        ...
                        <div class="col-lg-auto col-md-4 col-6 mb-2 mb-lg-0">
                            <label class="form-label fw-semibold d-block" style="color: #0d6efd; visibility: hidden;">Clear</label>
                            <a href="{{ route('staff-feedback') }}" class="btn btn-outline-secondary w-100">
            ...
            @if($allFeedback->isEmpty())
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center py-5">
                        <i class="bi bi-chat-left-dots" style="font-size: 4rem; opacity: 0.3; color: #0d6efd;"></i>
                                ...
                                <tbody>
                                    @foreach($allFeedback as $feedback)
                                        <tr class="feedback-row">
                                            <td>
                                                <strong style="color: #0d6efd;">{{ $feedback->patient && $feedback->patient->info
                                            ...
                                            <td class="text-center">
                                                @if($feedback->patient_feedback)
                                                    <div class="feedback-comment">
                                                        <em style="color: #0d6efd; font-weight: 500;">{{ $feedback->patient_feedback }}</em>
                                                    </div>
                                                @else
