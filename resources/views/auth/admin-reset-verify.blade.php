    ...
    <div class="login-card">
        <div class="login-card-content">
            ...
            <form action="{{ route('admin.password.reset.verify.submit') }}" method="POST">
                ...
                <button type="submit" class="btn-custom-primary w-100 mb-3 bg-primary border-primary" id="verifyCodeBtn">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const form = document.querySelector('form[action="{{ route("admin.password.reset.verify.submit") }}"]');
