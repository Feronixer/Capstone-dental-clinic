...
<body class="admin-body">
        ...
        <div class="inactivity-password-content">
            ...
            <form id="inactivityPasswordForm">
                <div class="input-group mb-3">
                    ...
                    <button class="btn btn-outline-secondary" type="button" id="toggleInactivityPassword" aria-label="Show password">
                        <i class="bi bi-eye" id="toggleInactivityPasswordIcon"></i>
                    </button>
                </div>
        ...
        (function() {
            ...
            function resetInactivityTimer() {
                ...
                inactivityTimer = setTimeout(function() {
                    ...
                    localStorage.setItem('admin_inactivity_blurred', 'true');
                }, INACTIVITY_TIMEOUT);
            ...
            function showPasswordModal() {
                ...
                localStorage.setItem('admin_inactivity_locked', 'true');
                localStorage.setItem('admin_inactivity_blurred', 'true');
            }
            ...
            passwordForm.addEventListener('submit', function(e) {
                ...
                fetch('{{ route("admin.verify-inactivity-password") }}', {
                    method: 'POST',
                    headers: {
            ...
            function restoreInactivityState() {
                const isLocked = localStorage.getItem('admin_inactivity_locked') === 'true';
                const isBlurred = localStorage.getItem('admin_inactivity_blurred') === 'true';
    ...
    <script>
        ...
        window.currentUserId = {{ auth('admin')->id() ?? 'null' }};
    </script>
    ...
    <script>
        (function() {
            ...
            document.addEventListener('click', function(e) {
                ...
                const isInternalAdmin = href && (
                    href.startsWith('/admin/') || 
                    href.includes('/admin/') ||
                    (href.startsWith('http') && href.includes(currentHost) && href.includes('/admin/'))
                );
    ...
    <script>
        (function() {
            ...
            document.addEventListener('click', function(e) {
                if (e.target.closest('#toggleInactivityPassword')) {
                    const toggleBtn = document.getElementById('toggleInactivityPassword');
                    const passwordInput = document.getElementById('inactivityPassword');
                    const toggleIcon = document.getElementById('toggleInactivityPasswordIcon');
