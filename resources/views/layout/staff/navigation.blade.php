            ...
            <ul class="nav-menu-list">
                ...
                <li class="{{ request()->routeIs('staff-appointment') ? 'active' : '' }}">
                    <a href="{{ route('staff-appointment') }}" class="nav-item-link">
                        ...
                        @if(request()->routeIs('staff-appointment'))
                            <div class="nav-active-indicator"></div>
                        @endif
                    </a>
                </li>
                ...
                <li class="{{ request()->routeIs('staff-account-management') ? 'active' : '' }}">
                    <a href="{{ route('staff-account-management') }}" class="nav-item-link">
                        ...
                        @if(request()->routeIs('staff-account-management'))
                            <div class="nav-active-indicator"></div>
                        @endif
                    </a>
                </li>
                ...
                <li class="{{ request()->routeIs('staff-content-management') ? 'active' : '' }}">
                    <a href="{{ route('staff-content-management') }}" class="nav-item-link">
                        ...
                        @if(request()->routeIs('staff-content-management'))
                            <div class="nav-active-indicator"></div>
                        @endif
                    </a>
                </li>
                ...
                <li class="{{ request()->routeIs('staff-post-procedural') ? 'active' : '' }}">
                    <a href="{{ route('staff-post-procedural') }}" class="nav-item-link">
                        ...
                        @if(request()->routeIs('staff-post-procedural'))
                            <div class="nav-active-indicator"></div>
                        @endif
                    </a>
                </li>
            ...
            <ul class="nav-menu-list">
                ...
                <li class="{{ request()->routeIs('staff-notification') ? 'active' : '' }}">
                    <a href="{{ route('staff-notification') }}" class="nav-item-link">
                        ...
                        @if(request()->routeIs('staff-notification'))
                            <div class="nav-active-indicator"></div>
                        @endif
                    </a>
                </li>
                ...
                <li class="{{ request()->routeIs('staff-profile') ? 'active' : '' }}">
                    <a href="{{ route('staff-profile') }}" class="nav-item-link">
                        ...
                        @if(request()->routeIs('staff-profile'))
                            <div class="nav-active-indicator"></div>
                        @endif
                    </a>
                </li>
...
<div class="modal fade" id="staffLogoutModal" tabindex="-1" aria-labelledby="staffLogoutModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content logout-modal-content">
            <div class="modal-body text-center p-4">
                ...
                <h5 class="logout-modal-title mb-2" id="staffLogoutModalLabel">Logout</h5>
                ...
                <div class="d-flex gap-2 justify-content-center">
                    ...
                    <button type="button" class="btn btn-confirm-logout" id="confirmStaffLogoutBtn">Yes</button>
                </div>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (staffLogoutBtn) {
        staffLogoutBtn.addEventListener('click', function(e) {
            e.preventDefault();
            const modalElement = document.getElementById('staffLogoutModal');
            if (modalElement) {
    ...
    const confirmLogoutBtn = document.getElementById('confirmStaffLogoutBtn');
    if (confirmLogoutBtn) {
        confirmLogoutBtn.addEventListener('click', function() {
            const logoutForm = document.getElementById('staff-logout-form');
            if (logoutForm) {
                logoutForm.submit();
            }
        });
