    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                ...
                <!-- Action Buttons -->
                <div class="d-flex gap-2">
                    <a href="{{ route('admin-appointment.table') }}" class="btn btn-info" title="Table View">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('today-btn').addEventListener('click', function() {
        ...
        // Update current date to today based on server time and regenerate calendar without reloading the page
    ...
    document.getElementById('clear-all-future-blocks-btn').addEventListener('click', function() {
        ...
        fetch('/admin/blocked-time/future/count', {
            method: 'GET',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Accept': 'application/json',
    ...
    document.getElementById('confirm-clear-all-future-btn').addEventListener('click', function() {
        ...
        fetch('/admin/blocked-time/future/clear', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Accept': 'application/json',
