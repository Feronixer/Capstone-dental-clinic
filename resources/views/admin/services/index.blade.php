    ...
    <div class="row g-4 mb-4">
        <div class="col-12 col-md-6 col-xl-4">
            <div class="services-metric-card">
                ...
                <small class="text-muted">Active offerings in the clinic</small>
            </div>
        </div>
        <div class="col-12 col-md-6 col-xl-4">
            <div class="services-metric-card">
                ...
                <h6 class="text-muted text-uppercase mb-1">Latest Service</h6>
                <h3 class="fw-bold mb-0">{{ $latestService?->service_name ?? '—' }}</h3>
                <small class="text-muted">
                    {{ $latestService && $latestService->created_at ? 'Added on ' . $latestService->created_at->timezone('Asia/Manila')->format('M j, Y') : 'No recent additions' }}
                </small>
            </div>
        </div>
    </div>
